...
{{- define "rocketchat.metadata" }}
name: {{ include "rocketchat.fullname" . }}
labels: {{- include "rocketchat.labels" . | nindent 2 }}
{{- end }}

{{/*Get airlock namespace*/}}
{{- define "rocketchat.airlock.namespace" }}
    {{ default .Release.Namespace .Values.airlock.namespace | quote }}
{{- end }}