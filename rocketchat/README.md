...
| `existingMongodbSecretKey`                 | The key for the already existing secret containing MongoDB Connection URL                                                                                                                                                                                                                                                                                                                                                                                      | `""`                               |
| `existingMongodbOplogSecretKey`            | The key for the already existing secret containing MongoDB Connection URL to Oplog                                                                                                                                                                                                                                                                                                                                                                             | `""`                               |
