...
| `httproute.hostnames`                  | Hostnames matched against the HTTP Host header. Defaults to `[host]` when empty                                                                                                                                                                                                                                                                                                                                                                                | `[]`                               |
| `httproute.matches`                    | Matches for the main Rocket.Chat rule. Defaults to a `PathPrefix` `/` match                                                                                                                                                                                                                                                                                                                                                                                    | `[{path: {type: PathPrefix, value: /}}]` |
| `httproute.annotations`                | Annotations for the HTTPRoute                                                                                                                                                                                                                                                                                                                                                                                                                                  | `{}`                               |
| `httproute.filters`                    | A list of [HTTPRouteFilter](https://gateway-api.sigs.k8s.io/api-types/httproute/#filters-optional) applied to the main rule                                                                                                                                                                                                                                                                                                                                    | `[]`                               |
| `httproute.additionalRules`            | Templated list of custom HTTPRoute rules prepended to the main route                                                                                                                                                                                                                                                                                                                                                                                          | `[]`                               |
| `httproute.federation.serveWellKnown`  | If `true` (and `federation.enabled`), adds `/.well-known/matrix/{server,client}` routes to the wellknown service                                                                                                                                                                                                                                                                                                                                               | `false`                            |
